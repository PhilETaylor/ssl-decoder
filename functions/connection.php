    ...
    <div class="panel panel-default">
        <div class="panel-heading" role="tab" id="heading-correct-chain">
            <h4 class="panel-title">
                <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapse-correct-chain"
                   aria-expanded="false" aria-controls="collapse-correct-chain">
                    Click to Open/Close
                </a>
            </h4>
        </div>
        <div id="collapse-correct-chain" class="panel-collapse collapse" role="tabpanel"
             aria-labelledby="heading-correct-chain">
